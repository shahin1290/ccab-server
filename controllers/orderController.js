...
exports.createOrder = async (req, res) => {
  ...
  try {
    ...
    if (
      (order._id && id === "Front End Half Time Plan") ||
      (order._id && id === "Front End Full Time Plan") ||
      (order._id && id === "Full Stack Half Time Plan") ||
      (order._id && id === "Full Stack Full Time Plan")
    ) {
      //send mail to admin
...
exports.createKlarnaOrder = async (req, res) => {
  ...
  try {
    ...
    if (
      bootcampId === "Front End Half Time Plan" ||
      bootcampId === "Front End Full Time Plan" ||
      bootcampId === "Full Stack Half Time Plan" ||
      bootcampId === "Full Stack Full Time Plan" ||
      bootcampId === "bill"
    ) {
      course = bootcampId;
    } else {
    ...
    //update bootcamp students array
    if (
      (order._id && bootcampId === "Front End Half Time Plan") ||
      (order._id && bootcampId === "Front End Full Time Plan") ||
      (order._id && bootcampId === "Full Stack Half Time Plan") ||
      (order._id && bootcampId === "Full Stack Full Time Plan")
    ) {
      //send mail to admin
      sendMail(res, toUser, subject, html);
